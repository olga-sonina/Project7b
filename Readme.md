...
The core problem initially posed on the Kaggle competition platform ([https://www.](https://www.kaggle.com/competitions/home-credit-default-risk/overview) [kaggle.com/competitions/home-credit-default-risk/overview](https://www.kaggle.com/competitions/home-credit-default-risk/overview)) and on the whole con- sist on how to classify clients with no or little credit history using alternative type of financial information about them. It is important to notice that according to Kaggle competition rules (<https://www.kaggle.com/competitions/home-credit-default-risk/rules> data could be used only for the competition aim and in the present project used only with educational, non- profit goal.
